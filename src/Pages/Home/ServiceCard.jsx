...
const ServiceCard = ({services}) => {
    ...
    return (
        <div data-aos="fade-up" className="shadow-xl rounded-lg flex flex-col">
            ...
            <h3 className="mt-3 pl-6 font-bold text-xl md:text-2xl text-[#49516F]">{title}</h3>
            <p className="pl-6 text-base font-normal text-[#49516F] mt-3">{price}</p>
            <p className="pl-6 flex-grow pr-6 mt-3 md:text-sm lg:text-base font-normal text-[#49516F]">{description}</p>
            <div className="pl-6">
